...
- [📖  Rails React Hello World ](#-hello-rails-react-)
...
# Rails-react-hello-world <a name="hello-rails-react"></a>
** Rails react hello world** is a web application that displays a random greeting message on screen, using **React** as front-end and **Rails** as back-end.
